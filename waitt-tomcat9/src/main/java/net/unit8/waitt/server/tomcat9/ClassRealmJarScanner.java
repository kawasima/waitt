...
public class ClassRealmJarScanner implements JarScanner {
    private static final Log log = LogFactory.getLog(ClassRealmJarScanner.class);
    ...
    static {
        ...
        ClassLoader cl = ClassRealmJarScanner.class.getClassLoader();
        while (cl != null) {
            cls.add(cl);
            cl = cl.getParent();
        }
