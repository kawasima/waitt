...
public class Tomcat10EmbeddedServer implements EmbeddedServer {
    final Tomcat tomcat;
    Context context;
    ...
    private Context addWebapp(String contextPath, String appBase, ClassLoader loader, boolean mainContext) {
        ...
        if (loader != null) {
            ...
            if (mainContext && ClassLoaderFactoryHolder.getClassLoaderFactory() != null) {
                webappLoader.setLoaderClass("net.unit8.waitt.server.tomcat10.Tomcat10WebappClassLoaderWrapper");
